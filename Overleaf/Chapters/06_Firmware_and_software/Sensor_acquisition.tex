...
A measurement is taken by a single call to \texttt{wheatstone\_read()}, which enables the IADC, issues one single-shot differential conversion across PC01 and PC02, retrieves the result, and then gates the IADC clocks and the bridge excitation back off.
