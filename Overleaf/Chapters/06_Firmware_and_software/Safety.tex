...
The deadline is armed once during initialisation, and because every wake from EM4 is a full reset the watchdog is effectively re-armed at the start of every cycle without any explicit reset logic.
