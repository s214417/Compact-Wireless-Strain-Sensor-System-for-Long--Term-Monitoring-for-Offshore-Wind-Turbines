...
\subsection{Signal Strength} \label{sec:signal_strength}
...
is required. The on-die temperature sensor of the EFR32MG22E is therefore evaluated to determine its
suitability for this purpose. The sensor is embedded within the silicon die of the Energy Management Unit (EMU) and reports absolute temperature with a nominal resolution of \SI{0.25}{\celsius} and a
...
To characterize the sensor's performance, the PCB was subjected to a controlled thermal
