...
Replacing the fixed bias resistors with matched sensing elements has the benefit of suppressing environmental drift. As these elements respond to the environment identically to the active sensors, resistance changes induced by environmental effects appear equally in both bridge arms and cancel in the differential output. 
