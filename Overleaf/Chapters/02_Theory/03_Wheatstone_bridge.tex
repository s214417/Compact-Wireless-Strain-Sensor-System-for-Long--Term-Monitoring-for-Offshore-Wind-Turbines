...
Replacing the fixed bias resistors with matched sensing elements offers a further, independent benefit. Environmental drift is now suppressed because these elements respond to the environment identically to the active sensors. Resistance changes induced by environmental effects appear equally in both bridge arms and cancel in the differential output. This temperature compensation is present whether the opposing arms are active, as in the full bridge, or passive elements that experience the environment but not the applied strain. Let the active and passive sensor resistances be modelled as:
