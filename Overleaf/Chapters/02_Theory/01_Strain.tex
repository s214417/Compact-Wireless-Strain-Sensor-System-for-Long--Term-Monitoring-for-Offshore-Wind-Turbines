...
During assembly of the bolted joint, the bolt undergoes tensile strain while the nut undergoes compressive strain, as shown in \cref{fig:strain}. This deformation is directly related to the preload in the bolt, and a reduction in preload will therefore result in a corresponding change in strain. This relationship enables strain to be used as an indicator for monitoring the mechanical state of the joint.
