...
\begin{tikzpicture}[line join=round, line cap=round, yscale=1]
...
\draw[very thick, fill=IBM3!30, rounded corners=1.6pt]
...
\draw[very thick, fill=IBM1!69, rounded corners=1.6pt]
