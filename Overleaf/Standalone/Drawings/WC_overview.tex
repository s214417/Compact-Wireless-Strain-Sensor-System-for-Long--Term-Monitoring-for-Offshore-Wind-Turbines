...
\begin{tikzpicture}[line join=round, line cap=round, line width=0.4pt]
...
\tikzset{
  ...
  link/.style={<->,
    ...
    line width=0.5pt, shorten <=0.1pt, shorten >=0.1pt, IBM5},
  link2/.style={<->,
    >={Stealth[length=2pt,width=1.6pt]},
    line width=0.5pt, shorten <=1pt, shorten >=1pt, IBM8},
  link3/.style={<->,
    >={Stealth[length=2pt,width=1.6pt]},
    line width=0.5pt, shorten <=1pt, shorten >=1pt, IBM10},
}
...
\begin{scope}[shift={(0.07,6.36)},scale=0.2]
    ...
    \node[coord, label=right:Coordinator] at (-4,-1) {};
    \node[router, label=right:Router] at (0,-1) {};
    \node[enddev, label=right:End device] at (3,-1) {};
