...
This stay-awake behavior is applied only after a genuine fresh join, since a restored stored network has already completed its interview in a previous session and can return to normal low-power polling immediately.
