...
\begin{document}
\begin{tikzpicture}[font=\small, scale=\FigScale]
...
\node[coord, label={[font=\small]right:Coordinator}] at (-7.5,3) {};
\node[router, label={[font=\small]right:Router}] at (-7.5,0) {};
\node[enddev, label={[font=\small]right:End device}] at (-7.5,-3) {};
\end{tikzpicture}
\end{document}