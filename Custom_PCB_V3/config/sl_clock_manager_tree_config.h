...
#define SL_CLOCK_MANAGER_DEFAULT_LF_CLOCK_SOURCE    SL_CLOCK_MANAGER_DEFAULT_LF_CLOCK_SOURCE_ULFRCO
#endif
...
#define SL_CLOCK_MANAGER_EM23GRPACLK_SOURCE    CMU_EM23GRPACLKCTRL_CLKSEL_ULFRCO
#endif
