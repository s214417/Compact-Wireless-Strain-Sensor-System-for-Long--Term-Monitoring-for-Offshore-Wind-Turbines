...
% Font
% Keep DTU heading structure, but use a serif body font closer to standard LaTeX output.
\IfFontExistsTF{Latin Modern Roman}
{\setmainfont{Latin Modern Roman}}
{\setmainfont{Arial}}
% Use this command for single lines or short snippets in the original DTU body font.
\newfontface\DTUOldBodyFont{Arial}
\newcommand{\dtuold}[1]{{\DTUOldBodyFont #1}}
...
\usetikzlibrary{shapes.geometric} % For the ellipse node shape (figure callouts)
...
% Custom siunitx unit for microstrain, e.g. \SI{800}{\micro\strain} -> 800 µε
\DeclareSIUnit{\strain}{\ensuremath{\varepsilon}}
