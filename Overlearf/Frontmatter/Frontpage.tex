...
\node[anchor=center, inner sep=0] at (current page.center)
     {\includestandalone[mode=buildmissing,width=\paperwidth]{Standalone/Drawings/frontpage}};
\end{tikzpicture}
...
%      {\includegraphics[height=18.9cm,keepaspectratio]{Pictures/prototype.png}};
% \end{tikzpicture}
\end{titlepage}